...
public class CarServiceTest {
    ...
    @Test
    void shouldRetrieveCorrectCarById() {
    ...
    @Test
    void shouldRetrieveCorrectCars() {
        Car car = new Car("TOYOTA", "Yaris", 2018, 20L);
    ...
    @Test
    void shouldUpdateCarsCorrectly() {
        Car car = new Car("TOYOTA", "Yaris", 2018, 20L);
        Mockito.when(carRepository.findById(20L)).thenReturn(Optional.of(car));
        //"Audi", "A3", 2015
    ...
    @Test
    void shouldDeletedCorrectCarById() {
        Car car = new Car();
        car.setId(10L);
